...
if getgenv().AutoAllBossHop then
   queue_on_teleport([[
      ...
      loadstring(game:HttpGet(('https://raw.githubusercontent.com/RawPublic/messagekuro/main/autoallbosshop.lua'),true))()
   ]])
end
...
Fruits:addToggle("Auto Store Fruits",true,function(value)
...
GameSection:addButton("Delete Ui",function()
   local ui = game:GetService("CoreGui"):FindFirstChild("NugrahaHub")
   if ui then
      ui:Destroy()
   end
end)
